          ...
          exercises: [
              {
                  ...
                  order: 0,
                  instructions: ["4-6 reps per set.", "Rest 2-3 minutes between sets.", "Use same weight for each set. Add 5 lbs after completing upper range of reps for all three sets."],
      ...
      }, 
      {
        ...
        exercises: [
            ...
            },
            {
                ...
                videoLink: "https://my.kinobody.com/courses/66905/lectures/989806",
                order: 3,
                instructions: [ "8-12 reps per set", "Rest 2 minutes between each set.", "Same weight for each set. Add 5 lbs after completing upper range of reps for all three sets."],
                type: "Standard Pyramid",
                weightIncrement: 2.5,
                startWeight: 2.5,
                weightType: "cable",
      ...
      },
      {
        ...
        exercises: [
            ...
            },
            {
                ...
                videoLink: "https://my.kinobody.com/courses/66905/lectures/989806",
                order: 1,
                instructions: [ "6-10 reps per set.", "Rest 2 minutes between sets.", "Start with weaker foot, keep foot on bench. Rest 2 minutes between each set. Same weight for each set. Add 5 lbs after completing upper range of reps for all three sets."],
                type: "Standard Pyramid",
                weightIncrement: 5,
                startWeight: 0,
                weightType: "dumbbells",
            ...
            },
            {
                ...
                videoLink: "https://my.kinobody.com/courses/66905/lectures/989806",
                order: 2,
                instructions: [ "6-10 reps per set.", "Rest 2-3 minutes between sets.", "Same weight for each set. Add 5 lbs after completing upper range of reps for all three sets."],
                type: "Standard Pyramid",
                weightIncrement: 5,
                startWeight: 0,
                weightType: "dumbbells",
            ...
            },
            {
                ...
                videoLink: "https://my.kinobody.com/courses/66905/lectures/989806",
                order: 3,
                instructions: [ "8-12 reps per set.", "Rest 2 minutes between sets.", "Reduce by 10% each time."],
